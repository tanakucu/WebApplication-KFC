...
//         this.shadowRoot.querySelectorAll(".products")[index];
...
//     const recommendedProductsContainer = this.shadowRoot.getElementById(
...
class BasketComponent extends HTMLElement {
  ...
  constructor() {
    ...
    this._title = this.getAttribute("data-title") || "Basket";
    this._theme = this.getAttribute("data-theme") || "light";
  ...
  updateTheme() {
    if (this._theme === "dark") {
      this.shadowRoot.host.style.setProperty("--background-color", "#454343");
      this.shadowRoot.host.style.setProperty("--text-color", "black");
    } else {
      this.shadowRoot.host.style.setProperty("--background-color", "#fff");
      this.shadowRoot.host.style.setProperty("--text-color", "#000");
    }
  }
  ...
  setupEventListeners() {
    ...
    this.addEventListener("orderPlaced", (event) => {
